...
const AboutCompact = () => {
  ...
  return (
    <section className="about-compact" ref={ref}>
      <div className="container">
        <motion.div
          className="about-compact-content"
          initial={{ opacity: 0, y: 20 }}
          animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }}
          transition={{ duration: 0.6 }}
        >
          <div className="about-compact-main">
            <div className="about-compact-left">
              ...
              <div className="about-compact-actions">
                <Link href="/#about" className="about-compact-btn">
                  소개 보기
                </Link>
              </div>
            </div>
            <div className="about-compact-right">
              ...
              >
                <h1 className="about-compact-title">포트폴리오</h1>
                <div className="about-compact-social">
